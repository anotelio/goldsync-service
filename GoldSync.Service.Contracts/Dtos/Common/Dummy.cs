namespace GoldSync.Service.Contracts.Dtos.Common;

/// <summary>
/// Represents a void type, since <see cref="void"/> is not a valid return type in C#.
/// </summary>
public readonly struct Dummy : IEquatable<Dummy>, IComparable<Dummy>, IComparable
{
    private static readonly Dummy value = new();

    /// <summary>
    /// Default and only value of the <see cref="Dummy"/> type.
    /// </summary>
    public static ref readonly Dummy Value => ref value;

    /// <summary>
    /// Task from a <see cref="Dummy"/> type.
    /// </summary>
    public static Task<Dummy> Task { get; } = System.Threading.Tasks.Task.FromResult(value);
...
#pragma warning disable RCS1163 // Unused parameter.
    ...
    public static bool operator ==(Dummy first, Dummy second) => true;
    ...
    public static bool operator !=(Dummy first, Dummy second) => false;
